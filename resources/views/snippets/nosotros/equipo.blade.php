<div class="equipo">
    ...
    <div class="card">
        <img src="{{ asset('image/nosotros/equipo/hugo_miranda.png') }}" alt="Hugo Miranda">
        <div class="card-body">
        ...
        <div class="card-footer">
            ...
            <a href=""><img src="{{ asset('image/nosotros/equipo/cv.png') }}" alt=""></a>
        </div>
    </div>
     <div class="card">
        <img src="{{ asset('image/nosotros/equipo/equipo_user.png') }}" alt="Hugo Miranda">
        <div class="card-body">
