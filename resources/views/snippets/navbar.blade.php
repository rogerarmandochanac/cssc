<nav class="bg-blue">
    <div id="navbar">
        ...
        <ul class="nav_links bg-blue">
            <li class="nav_list"><a href="#" class="nav_link mona-sans">Inicio</a></li>
            <li class="nav_list"><a href="#" class="nav_link mona-sans">Nosotros</a></li>
            <li class="nav_list nav_servicios">
                ...
                <ul class="submenu" id="submenu-servicios">
                    <li><a href="#" class="nav_link mona-sans">Diagnóstico 360° de Ciberseguridad y Compliance</a></li>
                    <li><a href="#" class="nav_link mona-sans">Red Team y Ethical Hacking</a></li>
                    <li><a href="#" class="nav_link mona-sans">Alineamiento Legal y Normativo</a></li>
                    <li><a href="#" class="nav_link mona-sans">Implementación de SGS</a></li>
                    <li><a href="#" class="nav_link mona-sans">Análisis de Riesgos y Planes de Acción</a></li>
                    <li><a href="#" class="nav_link mona-sans">Capacitación y Concientización</a></li>

                </ul>
            </li>
            <li class="nav_list"><a href="#" class="nav_link mona-sans">Contacto</a></li>
